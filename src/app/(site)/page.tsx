        ...
        >
          <div className="max-w-xl">
            ...
            <p className="mt-6 max-w-md text-base text-neutral-800 leading-relaxed">
              ...
              suspension shops &mdash; clean oil, fresh wear parts, and work
              done with real care.
            </p>
          </div>
        </section>
        ...
        <section className="scroll-mt-24">
          <div className="max-w-3xl border-t border-neutral-100 pt-16 pb-16 lg:pt-24 lg:pb-24">
            ...
            <p className="mt-4 text-base text-neutral-800 leading-relaxed">
              ...
              overpriced, wrapped in mystique, and vague about what was even
              done. Lucid isn&apos;t a race-team tuning lab or a secret-sauce
              revalve brand &mdash; it&apos;s the straightforward option: clean
              oil, fresh wear parts, and careful work done the right way.
            </p>
            ...
            <dl className="mt-10 space-y-10">
              ...
              <div className="flex flex-col gap-2 border-l border-neutral-200 pl-5">
                ...
                <dd className="text-base text-neutral-800 leading-relaxed">
                  No mystique and no ego. Just transparent suspension work you
                  can trust.
                </dd>
              </div>
        ...
        <section className="scroll-mt-24">
          <div className="max-w-3xl border-t border-neutral-100 pt-10 pb-10">
            ...
            <p className="mt-3 text-base text-neutral-800 leading-relaxed">
              Lucid Suspension is in build mode &mdash; refining the service
              flow, sharpening the standards, and dialing in the details that
              define the Lucid way, so the first customer jobs start from a
              process that already feels solid and well-proven.
            </p>

            <p className="mt-3 text-sm text-neutral-600 leading-relaxed">
              If you&apos;d like to reach out ahead of launch, you can send a
              note to{" "}
              <a
                href="mailto:aaron@lucidsuspension.com"
        ...
        <section className="scroll-mt-24">
          <div className="max-w-3xl border-t border-neutral-100 pt-16 pb-16 lg:pt-24 lg:pb-24">
            ...
            <p className="mt-4 text-base text-neutral-800 leading-relaxed">
              ...
              job updates while your parts are in the shop, and a direct line
              when you need it. Members also receive rider-first touches &mdash;
